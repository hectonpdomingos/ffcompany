...
// function addPackage($addpackegetracknumber, $userid){
// echo '<br>';
// echo "  You can add this ".$addpackegetracknumber. " track number, to this ".$userid." ID.";
// echo '<br>';
// }
...
function addPackage($userid, $addpackageuseremail,  $addpackagefrom, $addpackagetracknumber, $addstatus, $addpackageweight){
     ...
     VALUES (:user_id ,:addpackageuseremail ,:addpackagefrom ,:addpackagetracknumber ,:addstatus ,:addpackageweight ,:date_arrive)";
  ...
  catch(PDOException $e)
      {
        echo $e->getMessage();
            ...
            echo "This track number is using by another package. ";
  ...
  echo "Package added sucessufully!";
...
try{
  ...
  echo "The original owner is: ".$pkguseremail." Do you really want tranfer this package to ".$addpackageuseremail." user? All changes will be reported.";
  }
