        ...
        <body>
            ...
            <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
                ...
                <ul class="nav menu">
                    ...
                    <li class="active"><a href="alerts.php"><span  class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span > Alerts</a></li>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="page-header">Dashboard Alerts Report</h4>
